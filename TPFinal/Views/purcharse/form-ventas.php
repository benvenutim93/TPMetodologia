<div class="content-chico">
                <form class="form-signin" action= "<?php echo FRONT_ROOT?>Admin/showPurcharses " method="GET">
                            ...
                            <!--I N P U T-->
                            <input type="date" name="dateInicial" id= "dateInicial" class="form-control" placeholder="Ingrese Fecha" required>

                            <label for="dateFinal" >Ingrese Fecha Final</label>

                            <input type="date" name="dateFinal" id= "dateFinal" class="form-control" placeholder="Ingrese Fecha" required>
